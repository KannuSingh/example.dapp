import { Avatar, Button, Center, HStack, Icon, Popover, PopoverArrow, PopoverBody, PopoverContent, PopoverHeader, PopoverTrigger, Portal, Text, Tooltip, VStack, useBoolean, useClipboard, useColorModeValue, useToast } from "@chakra-ui/react";
import {  FaChevronDown, FaChevronUp, FaCopy, FaPowerOff } from "react-icons/fa"
...
export default function UserProfile() {
  ...
  const handleDisconnect = async () => {
    ...
    try{
      ...
      const passkeyZkAccountContract = PasskeyXzkAccount.getPasskeyZkAccountContract(address,provider)
