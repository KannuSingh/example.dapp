...
export class PasskeyXzkAccount {
    ...
    static getPasskeyZkAccountContract(address:string,signerOrProvider:Signer|Provider):PasskeyZkAccount {
       return  new Contract(address, PASSKEY_ZK_ACCOUNT_ABI, signerOrProvider) as unknown as PasskeyZkAccount 
    }
    static getEntryPointContract(signerOrProvider:Signer|Provider){
